...
self.addEventListener('install', function(e) {
  self.skipWaiting(); // activar imediatamente sem esperar fechar tabs antigas
  e.waitUntil(
...
self.addEventListener('activate', function(e) {
  e.waitUntil(
    caches.keys().then(function(keys) {
      ...
      return self.clients.claim(); // tomar controlo de todos os tabs abertos
    }).then(function() {
      // Notificar todos os tabs para recarregar (novo deploy detectado)
